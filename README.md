...
- **Страница:** раздел «3. DevTools Performance».
...
### 4. React Profiler и Self-profiling API

- **Страница:** раздел «4. React Profiler и Self-profiling API».
...
- **Как показывать:** записать профиль в React DevTools (Record → действия на странице → стоп), разобрать флеймграф. Для production-подобного билда: `npm run preview:profiling`.
